...
lang: en
city_slug: rotterdam
title: "Rotterdam — Half-Day City Tour"
description: "A city bombed flat in 1940 and rebuilt as the boldest architectural experiment in Europe. No medieval charm — something stranger and better."
---
...
### 2. Cube Houses (Kubuswoningen) — Architecture
...
### 3. Oudehaven & Witte Huis — Old Harbour
...
### 4. Erasmusbrug & Wilhelminapier — Bridge & Waterfront
...
### 5. Depot Boijmans Van Beuningen — Art Storage
...
- **Morning:** Markthal food stalls — cheese, pastries, coffee, all in one dramatic space.
- **Lunch:** **Fenix Food Factory** (Veerlaan 19d, Katendrecht, south bank) — a warehouse converted to a food hall with Rotterdam's best craft beer and local producers. 10 minutes from the Depot by tram.
- **End-of-tour drink:** Hotel New York terrace on the Wilhelminapier — river views, good wine list, old-world atmosphere.
...
- **15 minutes.** The entire historic centre of Rotterdam was destroyed in approximately 15 minutes on 14 May 1940. The fire burned for two days. The bombing was a deliberate act intended to terrorize the Dutch government into surrendering — and it worked. The Netherlands capitulated the following morning.
- **Europe's largest port.** Rotterdam handles about 467 million tonnes of cargo per year — more than the next two largest European ports combined. The port stretches 40 km from the city to the North Sea and processes around 30,000 ocean-going vessels annually.
- **The Erasmusbrug wobbles.** When the bridge opened in 1996, it developed an unexpected resonant vibration in moderate winds. In 2010, engineers installed 52 hydraulic dampers along the cables to absorb the movement. The bridge is now stable — but the problem wasn't anticipated in the original design.
- **The Markthal's ceiling.** The *Horn of Plenty* mural by Arno Coenen and Iris Roskam took four years to complete and contains approximately 4,000 individual digital paintings merged into a single 11,000 m² image. It's rendered on 4,000 aluminium panels.
- **Free architecture tours.** Rotterdam Architecture Month runs every May, with hundreds of open building events. Free guided architecture walks run every Saturday year-round from the Markthal.
- **Piet Blom's cube house logic.** Blom designed the cubes so that each one is abstractly a "tree" — the cube is the canopy, the pylon is the trunk — and the whole cluster is a "village forest." This makes more sense as a poetic concept than as housing. The interiors have roughly 100 m² of usable floor space per cube despite the geometric complexity.
- **Rotterdam's architects are serious.** The city has more OMA (Rem Koolhaas's firm) buildings than any city outside Asia. Koolhaas grew up in Rotterdam.
