...
lang: en
city_slug: utrecht
title: "Utrecht — Half-Day City Tour"
description: "A medieval tower without its church, canals you can drink at, and a railway museum that makes grown adults excited about trains."
---
...
- **Coffee:** Any wharf-level café on the Oudegracht — or **Café Olivier** (Achter Clarenburg 6), a Belgian brown café in a converted church, for an excellent *witbier*.
- **Lunch:** Sit on the Oudegracht wharves — most cafés serve solid Dutch lunch menus (uitsmijter, tostis, soup). **De Zakkendrager** at Oudegracht 45 is a reliable choice with a good terrace.
- **End-of-tour drink:** **Ledig Erf** square (Tolsteegbrug area) — the best outdoor terrace in Utrecht, especially good in afternoon sun.
...
- **The tornado of 1674.** On 1 August 1674, a waterspout from the southwest struck Utrecht and destroyed the nave of the Domkerk in minutes. Contemporary accounts describe the sound as like a cannon barrage. The ruins were cleared away over the following years. No serious proposal to rebuild the nave has ever been made.
- **Most important city for 800 years.** Utrecht was the seat of the Bishop of Utrecht from the 7th century onward. The bishop controlled territories stretching across what is now the central Netherlands, Friesland, and parts of Belgium — a domain comparable in size to many European kingdoms. This ended when the Prince of Orange acquired the Lordship of Utrecht in 1528.
- **Pope Adrian VI.** The only Dutch pope — Adrian VI (1459–1523) — was born on the Domplein in Utrecht. He was also the last non-Italian pope before John Paul II in 1978. His papacy lasted only 20 months, during which he tried unsuccessfully to reform the Catholic Church from within. He is generally considered a failure.
- **The Peace of Utrecht (1713).** Signed in the Stadhuis on the Oudegracht, the Peace of Utrecht ended the War of the Spanish Succession and established the principle of the balance of power in European diplomacy. It also transferred Gibraltar to Britain — which still holds it — and Newfoundland to Britain from France.
- **Oudegracht wharves.** The wharf system was established in the 13th century for commercial unloading: river barges moored at the lower level while goods were winched into the cellar warehouses via the arched openings you can still see in the stone. Wine, grain, textiles — all the trade of a medieval city passed through these vaults.
- **Largest railway station in the Netherlands.** Utrecht Centraal handles 110,000 passengers per day — more than any other station in the Netherlands, including Amsterdam Centraal. The station is currently the largest construction project in the country, with a new city district being built above and around the tracks.
